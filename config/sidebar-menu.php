...
return [
    ...
    [
        ...
        'permissions' => ['customer-sites.index'],
        'children' => [],
    ],
    ...
    [
        ...
        'isHeader' => false,
        'route' => '#',
        'permissions' => ['referrals.index', 'wallet-transactions.index', 'referral-point-settings.index'],
        'children' => [
            [
                'name' => 'Referrals',
                'icon' => '',
            ...
            [
                ...
                'permissions' => ['wallet-transactions.index'],
                'children' => [],
            ],
            [
                'name' => 'Referral Settings Rules',
                'icon' => '',
                'isHeader' => false,
                'route' => 'admin.referral-point-settings.index',
                'permissions' => ['referral-point-settings.index'],
                'children' => [],
            ],
        ],
    ],
    ...
    [
        ...
        'isHeader' => false,
        'route' => '#',
        'permissions' => ['customer-documents.index', 'document-types.index'],
        'children' => [
            [
                'name' => 'All Documents',
                'icon' => '',
                ...
                'permissions' => ['customer-documents.index'],
                'children' => [],
            ],
            [
                'name' => 'Document Types Master',
                'icon' => '',
                'isHeader' => false,
                'route' => 'admin.document-types.index',
                'permissions' => ['document-types.index'],
                'children' => [],
            ],
        ],
    ],
    ...
    [
        ...
        'isHeader' => false,
        'route' => '#',
        'permissions' => ['contentManagements.index', 'websites.index', 'faqs.index'],
        'children' => [
            [
                'name' => 'CMS Pages',
                'icon' => '',
                ...
                'permissions' => ['contentManagements.index'],
                'children' => [],
            ],
            [
            ...
            [
                ...
                'icon' => '',
                'isHeader' => false,
                'route' => ['admin.websites.index', 'type' => 'Products'],
                'permissions' => ['websites.index'],
                'children' => [],
            ],
            [
